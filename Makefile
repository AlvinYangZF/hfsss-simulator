...
TEST_CMD_INTEG_BASIC = $(BIN_DIR)/test_cmd_integration_basic
TEST_CMD_INTEG_MID = $(BIN_DIR)/test_cmd_integration_midcomplex
TEST_CMD_INTEG_HEAVY = $(BIN_DIR)/test_cmd_integration_heavy
TEST_CMD_ENGINE_NOTIFIER = $(BIN_DIR)/test_cmd_engine_notifier
TEST_DIE_DISPATCHER_UNIT = $(BIN_DIR)/test_die_dispatcher_unit
TEST_DIE_DISPATCHER_MT = $(BIN_DIR)/test_die_dispatcher_mt
TEST_DIE_DISPATCHER_ENGINE = $(BIN_DIR)/test_die_dispatcher_engine
TEST_DIE_DISPATCHER_FAULTS = $(BIN_DIR)/test_die_dispatcher_faults
TEST_TICKET_LOCK = $(BIN_DIR)/test_ticket_lock
...
COVERAGE_UT_BINS = $(COVERAGE_BIN_DIR)/test_common $(COVERAGE_BIN_DIR)/test_media \
	...
	$(COVERAGE_BIN_DIR)/test_cmd_engine_notifier \
...
$(TEST_TIMING_JITTER): $(TEST_DIR)/test_timing_jitter.c $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-media -lhfsss-common $(LDFLAGS)
...
$(TEST_CMD_INTEG_MID): $(TEST_DIR)/test_cmd_integration_midcomplex.c $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-media -lhfsss-common $(LDFLAGS)

$(TEST_CMD_INTEG_HEAVY): $(TEST_DIR)/test_cmd_integration_heavy.c $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-media -lhfsss-common $(LDFLAGS)

$(TEST_CMD_ENGINE_NOTIFIER): $(TEST_DIR)/test_cmd_engine_notifier.c $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-media -lhfsss-common $(LDFLAGS)

$(TEST_DIE_DISPATCHER_UNIT): $(TEST_DIR)/test_die_dispatcher_unit.c $(LIBHFSSS_FTL) $(LIBHFSSS_HAL) $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-ftl -lhfsss-hal -lhfsss-media -lhfsss-common $(LDFLAGS)

$(TEST_DIE_DISPATCHER_MT): $(TEST_DIR)/test_die_dispatcher_mt.c $(TEST_DIR)/cmd_engine_mock.c $(TEST_DIR)/cmd_engine_mock.h $(LIBHFSSS_FTL) $(LIBHFSSS_HAL) $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $(TEST_DIR)/test_die_dispatcher_mt.c $(TEST_DIR)/cmd_engine_mock.c -o $@ -L$(LIB_DIR) -lhfsss-ftl -lhfsss-hal -lhfsss-media -lhfsss-common $(LDFLAGS)

$(TEST_DIE_DISPATCHER_ENGINE): $(TEST_DIR)/test_die_dispatcher_engine.c $(LIBHFSSS_FTL) $(LIBHFSSS_HAL) $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-ftl -lhfsss-hal -lhfsss-media -lhfsss-common $(LDFLAGS)

$(TEST_DIE_DISPATCHER_FAULTS): $(TEST_DIR)/test_die_dispatcher_faults.c $(LIBHFSSS_FTL) $(LIBHFSSS_HAL) $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-ftl -lhfsss-hal -lhfsss-media -lhfsss-common $(LDFLAGS)

$(TEST_TICKET_LOCK): $(TEST_DIR)/test_ticket_lock.c $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-common $(LDFLAGS)

$(TEST_FTL_PROFILE): $(TEST_DIR)/test_ftl_profile.c $(LIBHFSSS_FTL) $(LIBHFSSS_HAL) $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-ftl -lhfsss-hal -lhfsss-media -lhfsss-common $(LDFLAGS)

$(TEST_SSSIM_PROFILE): $(TEST_DIR)/test_sssim_profile.c $(LIBHFSSS_SSSIM) $(LIBHFSSS_FTL) $(LIBHFSSS_HAL) $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-sssim -lhfsss-ftl -lhfsss-hal -lhfsss-media -lhfsss-common -lm $(LDFLAGS)

$(TEST_PROFILE_MATRIX): $(TEST_DIR)/test_profile_matrix.c $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-media -lhfsss-common $(LDFLAGS)

$(TEST_MP_CONCURRENCY): $(TEST_DIR)/test_media_multi_plane_concurrency.c $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-media -lhfsss-common $(LDFLAGS)
...
$(TEST_RESET_ABORT_RACE): $(TEST_DIR)/test_reset_abort_race.c $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-media -lhfsss-common $(LDFLAGS)
...
$(TEST_GC_MT): $(TEST_DIR)/test_gc_mt.c $(LIBHFSSS_CTRL) $(LIBHFSSS_FTL) $(LIBHFSSS_HAL) $(LIBHFSSS_MEDIA) $(LIBHFSSS_COMMON)
	@echo "  CC      $@"
	@$(CC) $(CFLAGS) $< -o $@ -L$(LIB_DIR) -lhfsss-controller -lhfsss-ftl -lhfsss-hal -lhfsss-media -lhfsss-common -lm $(LDFLAGS)
...
test: all
	...
	@$(TEST_CMD_INTEG_MID)
	@echo ""
	@$(TEST_CMD_INTEG_HEAVY)
	@echo ""
	@$(TEST_CMD_ENGINE_NOTIFIER)
	@echo ""
	@$(TEST_DIE_DISPATCHER_UNIT)
	@echo ""
	@$(TEST_DIE_DISPATCHER_MT)
	@echo ""
	@$(TEST_DIE_DISPATCHER_ENGINE)
	@echo ""
	@$(TEST_DIE_DISPATCHER_FAULTS)
	@echo ""
	@$(TEST_TICKET_LOCK)
	@echo ""
