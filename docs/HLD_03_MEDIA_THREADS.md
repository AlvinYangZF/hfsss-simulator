...
|--------|----------|--------|------|----------|
| FR-MEDIA-001 | NAND层次结构管理 | P0 | V1.0 | 待实现 |
| FR-MEDIA-002 | 时序模型 | P0 | V1.0 | 待实现 |
| FR-MEDIA-003 | EAT计算引擎 | P0 | V1.0 | 待实现 |
| FR-MEDIA-004 | 并发控制 | P1 | V1.0 | 待实现 |
| FR-MEDIA-005 | 命令执行引擎 | P0 | V1.0 | 待实现 |
| FR-MEDIA-006 | 可靠性模型 | P1 | V1.0 | 待实现 |
| FR-MEDIA-007 | 坏块管理 | P1 | V1.0 | 待实现 |
| FR-MEDIA-008 | NOR Flash仿真 | P2 | V1.0 | 待实现 |
