...
| Algorithm Task Layer (FTL) | 22 | 19 | 1 | 2 | 0 | 86.4% | ↑ +6 (cmd state machine, retries, flow ctl, wear monitor, Error Log Page); FTL die-busy retry-spin replaced by per-die wait queue + completion-event-driven dispatch (`src/ftl/die_dispatcher.c`) — see `docs/superpowers/specs/2026-04-30-ftl-die-busy-waitqueue-design.md`; 012_seqwrite_verify latency gap closed via cmd_engine FIFO ticket lock (`docs/superpowers/specs/2026-05-08-cmd-engine-ticket-lock-design.md`) (`docs/superpowers/specs/2026-05-08-cmd-engine-ticket-lock-design.md`) |
