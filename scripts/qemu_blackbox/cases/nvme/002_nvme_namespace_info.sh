...
hfsss_case_assert_file_contains "$HFSSS_CASE_ARTIFACT_DIR/nvme-list-ns.stdout" "0x1|(^|[^0-9])1($|[^0-9])"
...
hfsss_case_assert_file_contains "$HFSSS_CASE_ARTIFACT_DIR/nvme-list-subsys.stdout" "nvme0"
